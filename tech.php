...
<div class="spec-container">
    <div class="spec-item">Interface</div>
    <div class="spec-data">USB2.0, LAN(10 BASE-T、100 BASE-TX), USB Flach Memory（Under 32GB, FAT32 format)</div>
</div>

<div class="spec-container">
    <div class="spec-item">Driver Operating Conditions</div>
    <div class="spec-data">2GHz CPU (minimum recommendation) 4GB RAM</div>
</div>

<div class="spec-container">
    <div class="spec-item">Display Resolution</div>
    <div class="spec-data">XGA (1024×768) (minimum recommendation)</div>
</div>
