...
<head>
    ...
    <meta name="description" content="Learn about the benefits of the Brother GTX and how easy it simplifies the DTG printing process for its users. See the 4 easy steps of DTG printing with Brother!">
    <title>The Benefits of DTG Printing | The Brother GTX DTG Printer</title>
    <!-- Bootstrap -->
...
<div class="container gtx">
    ...
    <section id="ben-do-more" class="txt-left">
        <div class="ben-do-more-container">
            ...
            <ul>
                <li>Unlimited color options and design reproduction</li>
                <li>Efficient short runs and one offs</li>
                <li>Quick and easy reprints</li>
                <li>Faster output and response to market trends</li>
                <li>Seamless printing over zippers and other difficult garments</li>
                <li>Reduced labor and training requirements</li>
